...
# Goal: Counting objects based on their colors using OpenCV from video file.
import cv2
import numpy as np

font = cv2.FONT_HERSHEY_SIMPLEX

# 'Video.mp4' this video was captured by me for this project. I have used colorful Ludo Gutis on knife board in kitchen to shoot this.
